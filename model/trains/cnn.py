...
model_path = r"C:\code\python3workspace\sentiment_demo\data\model\textcnn_model.hdf5"

model_pic_path = r"C:\code\python3workspace\sentiment_demo\data\model\pic\cnn.png"
...
def build_model(lr=0.0, lr_d=0.0, units=0, dr=0.0):
    ...
    x2 = Conv1D(32, kernel_size=3, padding='valid', kernel_initializer='he_uniform')(x1)
    avg_pool1_cnn3 = GlobalAveragePooling1D()(x2)
    max_pool1_cnn3 = GlobalMaxPooling1D()(x2)

    x3 = Conv1D(32, kernel_size=2, padding='valid', kernel_initializer='he_uniform')(x1)
    avg_pool3_cnn2 = GlobalAveragePooling1D()(x3)
    max_pool3_cnn3 = GlobalMaxPooling1D()(x3)

    x = concatenate([avg_pool1_cnn3, max_pool1_cnn3, avg_pool3_cnn2, max_pool3_cnn3])
    ...
    model.fit(X_train, y_ohe, batch_size=16, epochs=2, validation_split=0.1, verbose=1,
...
# plot_model(model, to_file=model_pic_path, show_shapes=True)
